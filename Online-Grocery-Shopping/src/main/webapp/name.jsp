...
<div class="container">
  <div class="row">
    <div class="col-md-12 text-center">
      <h3 class="animate-charcter"> Welcome
...
<table width="100%" style="margin-top: 80px;">
			...
			<tr>
				<td style="padding: 15px; text-align: center;" class="products"><img
					...
					<p style="font-size: 14pt; font-weight: bold;">Pure &amp;
						Gentle Bathing Bar (125gmx4)</p>
				...
				<td style="padding: 15px; text-align: center;" class="products"><img
					...
					<p style="font-size: 14pt; font-weight: bold;">Sunflower
						Refined Oil - Sun Lite (1Ltr)</p>
